  ...
  <div>
    <div class="fv-row mb-7">
      <label class="form-check form-switch form-check-custom form-check-solid">
        <input
          ...
          :disabled="__name__(snakeCase)_store.forms.create_update___name__(snakeCase) == 'see'"
        />
        <span
    ...
    <div class="fv-row mb-7">
      ...
      <input
        ...
        placeholder="Nombre"
        :readonly="__name__(snakeCase)_store.forms.create_update___name__(snakeCase) == 'see'"
      />
...
const setForm = () => {
  form_state.name = __name__(snakeCase)_store.items.__name__(snakeCase).selected_item.name;
  form_state.is_active = __name__(snakeCase)_store.items.__name__(snakeCase).selected_item.is_active;
};
const closeModal = () => {
