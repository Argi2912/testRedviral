<template>
  ...
  >
    ...
    <span
      v-if="preview != '' && !readonly"
      class="btn btn-icon btn-circle btn-active-color-primary d-flex w-25px h-25px bg-body shadow"
...
onMounted(() => {
  if (props.imageUrl) preview.value = props.imageUrl;
});
</script>
