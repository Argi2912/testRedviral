            ...
            <div class="card-body pt-15">
              ...
              <div class="d-flex flex-center flex-column mb-5">
                ...
                <div class="d-flex flex-wrap flex-center">
                  <!--begin::Stats-->
                  <div
                    v-for="(detail_box, i) in detailBoxes"
                    :key="'detail_box_' + i"
                    class="border border-gray-300 border-dashed rounded py-3 px-3 mx-2 mb-3"
                  >
                    <div class="fs-4 fw-bold text-gray-700">
                      <span class="w-75px">{{ detail_box.title }}</span>
                    </div>
              ...
              <div id="kt_customer_view_details" class="collapse show">
                <div class="py-5 fs-6">
                  <!--begin::Details item-->
                  <span v-for="(detail, i) in details" :key="'detail_' + i">
                    <div class="fw-bold mt-5">{{ detail.title }}</div>
            ...
            <div class="card-body py-0">
              ...
              <div class="d-flex flex-wrap flex-stack mb-5">
                ...
                <div class="d-flex flex-wrap">
                  <div
                    v-for="(description_box, i) in description.boxes"
                    :key="'description_box_' + i"
                  ...
                  >
                    <span class="fs-1 fw-bold text-gray-800 lh-1">
                      <span
                        ...
                        >{{ description_box.title }}</span
                      >
                    </span>
                    <span
                      class="fs-6 fw-semibold text-muted d-block lh-1 pt-2"
                      >{{ description_box.description }}</span
                    >
                  </div>
                </div>
                <!--end::Row-->
                <slot name="description-options"></slot>
              </div>
              <!--end::Left Section-->
            </div>
            <!--end::Body-->
              ...
              >
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                  ...
                  <select
                    ...
                    data-select2-id="select2-data-10-4unz"
                    tabindex="-1"
                    aria-hidden="true"
                    data-kt-initialized="1"
                  >
                    <option data-select2-id="select2-data-12-rzk7"></option>
                  ...
                  ><span
                    ...
                    dir="ltr"
                    data-select2-id="select2-data-11-6e0b"
                    style="width: 100%"
                    ><span class="selection"
                      ><span
                        ...
                        tabindex="0"
                        aria-disabled="false"
                        aria-labelledby="select2-status-z7-container"
                        aria-controls="select2-status-z7-container"
                        ><span
                          class="select2-selection__rendered"
                          id="select2-status-z7-container"
                          role="textbox"
                          aria-readonly="true"
              ...
              >
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                  ...
                  <select
                    ...
                    data-placeholder="Select an option"
                    data-hide-search="true"
                    data-select2-id="select2-data-13-hrec"
                    tabindex="-1"
                    aria-hidden="true"
                    data-kt-initialized="1"
                  >
                    <option data-select2-id="select2-data-15-uje7"></option>
                    <option value="1">Credit</option>
                    <option value="2">Debit</option></select
                  ><span
                    class="select2 select2-container select2-container--bootstrap5"
                    dir="ltr"
                    data-select2-id="select2-data-14-z41c"
                    style="width: 100%"
                    ><span class="selection"
                      ><span
                        class="select2-selection select2-selection--single form-select form-select-solid fw-bold"
                        ...
                        tabindex="0"
                        aria-disabled="false"
                        aria-labelledby="select2-adjustment-3b-container"
                        aria-controls="select2-adjustment-3b-container"
                        ><span
                          class="select2-selection__rendered"
                          id="select2-adjustment-3b-container"
                          role="textbox"
                          aria-readonly="true"
                          title="Select an option"
                          ><span class="select2-selection__placeholder"
                ...
                <div class="fs-7 text-muted mb-15">
                  ...
                  audited by the financial team every fortnight. Please maintain
                  your invoices and receipts until then. Thank you.
                </div>
                <!--end::Disclaimer-->
                <!--begin::Actions-->
                <div class="text-center">
                  ...
                  >
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                      ...
                      <select
                        ...
                        class="form-select form-select-solid fw-bold select2-hidden-accessible"
                        data-select2-id="select2-data-16-hb7q"
                        tabindex="-1"
                        aria-hidden="true"
                        data-kt-initialized="1"
                      >
                        <option value="" data-select2-id="select2-data-18-efxm">
                          Select a Country...
                        </option>
                      ...
                      ><span
                        class="select2 select2-container select2-container--bootstrap5"
                        dir="ltr"
                        data-select2-id="select2-data-17-9mag"
                        style="width: 100%"
                        ><span class="selection"
                          ><span
                            class="select2-selection select2-selection--single form-select form-select-solid fw-bold"
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-country-cc-container"
                            aria-controls="select2-country-cc-container"
                            ><span
                              class="select2-selection__rendered"
                              id="select2-country-cc-container"
                              role="textbox"
                              aria-readonly="true"
                    ...
                    <div class="row fv-row fv-plugins-icon-container">
                      ...
                      <div class="col-6">
                        <select
                          ...
                          data-select2-id="select2-data-19-bav0"
                          tabindex="-1"
                          aria-hidden="true"
                          data-kt-initialized="1"
                        >
                          <option
                            data-select2-id="select2-data-21-9avq"
                          ></option>
                        ...
                        ><span
                          class="select2 select2-container select2-container--bootstrap5"
                          dir="ltr"
                          data-select2-id="select2-data-20-ligp"
                          style="width: 100%"
                          ><span class="selection"
                            ><span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-card_expiry_month-3j-container"
                              aria-controls="select2-card_expiry_month-3j-container"
                              ><span
                                class="select2-selection__rendered"
                                id="select2-card_expiry_month-3j-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Month"
                                ><span class="select2-selection__placeholder"
                      ...
                      <div class="col-6">
                        <select
                          ...
                          data-select2-id="select2-data-22-2jva"
                          tabindex="-1"
                          aria-hidden="true"
                          data-kt-initialized="1"
                        >
                          <option
                            data-select2-id="select2-data-24-00nf"
                          ></option>
                        ...
                        ><span
                          class="select2 select2-container select2-container--bootstrap5"
                          dir="ltr"
                          data-select2-id="select2-data-23-2gj1"
                          style="width: 100%"
                          ><span class="selection"
                            ><span
                              class="select2-selection select2-selection--single form-select form-select-solid"
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-card_expiry_year-f8-container"
                              aria-controls="select2-card_expiry_year-f8-container"
                              ><span
                                class="select2-selection__rendered"
                                id="select2-card_expiry_year-f8-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Year"
                                ><span class="select2-selection__placeholder"
