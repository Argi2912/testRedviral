  ...
  <div>
    <!-- <div class="fv-row mb-7">
      <label class="form-check form-switch form-check-custom form-check-solid">
        <input
          ...
          :disabled="test_uno_store.forms.create_update_test_uno == 'see'"
        />
        <span
    ...
    <div class="fv-row mb-7">
      ...
      <input
        ...
        placeholder="Nombre"
        :readonly="test_uno_store.forms.create_update_test_uno == 'see'"
      />
    ...
    <div align="right">
      <button
        ...
        @click="test_uno_store.closeModal()"
      >
        Cerrar
      </button>
      <button
        v-if="test_uno_store.forms.create_update_test_uno != 'see'"
        @click="handleSubmit()"
        type="button"
...
const handleSubmit = async () => {
  ...
  test_uno_store.forms.create_update_test_uno == "create"
    ? test_uno_store.createTestUno(form_state)
    : test_uno_store.updateTestUno(form_state, test_uno_store.items.test_uno.selected_item.id);
};

const setForm = () => {
  //API WARNING
  //SELECTED ITEM COMES WITH API ATTRIBUTE NAMES
  form_state.name = test_uno_store.items.test_uno.selected_item.name;
  form_state.description = 'Descripcion del TestUno '+test_uno_store.items.test_uno.selected_item.id;
  
};

onMounted(() => {
  if (test_uno_store.forms.create_update_test_uno != "create") setForm();
});
</script>

<script>
export default {
  name: "TestUnoFormComponent",
};
</script>
