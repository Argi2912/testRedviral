...
import { settings_methods, settings_properties } from "./settings.js";
  ...
  actions: {
    ...
    async init(route) {
      ...
      if (route.meta.active_form) {
        ...
        let settings = await this.findSettingsById(route.params.id);
        this.setSelectedItem("settings", settings);
        this.setModalTitle("Ver datos de settings");
        this.setModal("update_settings");
      }
