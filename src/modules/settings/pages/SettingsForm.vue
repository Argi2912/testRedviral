  ...
  <div>
    <div class="fv-row mb-7">
      <label class="form-check form-switch form-check-custom form-check-solid">
        <input
          ...
          :disabled="settings_store.forms.create_update_settings == 'see'"
        />
        <span
    ...
    <div class="fv-row mb-7">
      ...
      <input
        ...
        placeholder="Nombre"
        :readonly="settings_store.forms.create_update_settings == 'see'"
      />
    ...
    <div align="right">
      ...
      <button
        v-if="settings_store.forms.create_update_settings != 'see'"
        @click="handleSubmit()"
        type="button"
...
const handleSubmit = async () => {
  ...
  clearErrors()
  settings_store.forms.create_update_settings == "create"
    ? settings_store.createSettings(form_state)
    : settings_store.updateSettings(form_state, settings_store.items.settings.selected_item.id);
};

const setForm = () => {
  form_state.name = settings_store.items.settings.selected_item.name;
  form_state.is_active = settings_store.items.settings.selected_item.is_active;
};
const closeModal = () => {
...
onMounted(() => {
  if (settings_store.forms.create_update_settings != "create") setForm();
});
</script>
