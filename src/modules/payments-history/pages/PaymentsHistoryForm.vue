  ...
  <div>
    <div class="fv-row mb-7">
      <label class="form-check form-switch form-check-custom form-check-solid">
        <input
          ...
          :disabled="payments_history_store.forms.create_update_payments_history == 'see'"
        />
        <span
    ...
    <div class="fv-row mb-7">
      ...
      <input
        ...
        placeholder="Nombre"
        :readonly="payments_history_store.forms.create_update_payments_history == 'see'"
      />
    ...
    <div align="right">
      ...
      <button
        v-if="payments_history_store.forms.create_update_payments_history != 'see'"
        @click="handleSubmit()"
        type="button"
...
const handleSubmit = async () => {
  ...
  payments_history_store.forms.create_update_payments_history == "create"
    ? payments_history_store.createPaymentsHistory(form_state)
    : payments_history_store.updatePaymentsHistory(form_state, payments_history_store.items.payments_history.selected_item.id);
};

const setForm = () => {
  form_state.name = payments_history_store.items.payments_history.selected_item.name;
  form_state.is_active = payments_history_store.items.payments_history.selected_item.is_active;
};
const closeModal = () => {
...
onMounted(() => {
  if (payments_history_store.forms.create_update_payments_history != "create") setForm();
});
</script>
