  ...
  <div>
    <div class="fv-row mb-7">
      <label class="form-check form-switch form-check-custom form-check-solid">
        <input
          ...
          :disabled="tasks_store.forms.create_update_tasks == 'see'"
        />
        <span
    ...
    <div class="fv-row mb-7">
      ...
      <input
        ...
        placeholder="Nombre"
        :readonly="tasks_store.forms.create_update_tasks == 'see'"
      />
    ...
    <div align="right">
      ...
      <button
        v-if="tasks_store.forms.create_update_tasks != 'see'"
        @click="handleSubmit()"
        type="button"
...
const handleSubmit = async () => {
  ...
  tasks_store.forms.create_update_tasks == "create"
    ? tasks_store.createTasks(form_state)
    : tasks_store.updateTasks(form_state, tasks_store.items.tasks.selected_item.id);
};

const setForm = () => {
  form_state.name = tasks_store.items.tasks.selected_item.name;
  form_state.is_active = tasks_store.items.tasks.selected_item.is_active;
};
const closeModal = () => {
...
onMounted(() => {
  if (tasks_store.forms.create_update_tasks != "create") setForm();
});
</script>
