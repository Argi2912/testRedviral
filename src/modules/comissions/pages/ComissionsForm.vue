          ...
          >
            ...
            <li class="breadcrumb-item text-muted">
              <a
                ...
                @click="goToList"
                >{{ comissions_store.module_name }}</a
              >
            </li>
            <!--end::Item-->
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
      ...
      <div class="card">
        <div class="fv-row mb-7">
          <div class="col">
            <pre>{{comissions_store.items.comissions.selected_item}}</pre>
          </div>
        </div>
        <div class="row mt-6 mb-2 mx-6">
            <div align="right">
              ...
              <button
                v-if="comissions_store.forms.create_update_comissions != 'see'"
                @click="handleSubmit()"
                type="button"
...
const handleSubmit = async () => {
  ...
  comissions_store.forms.create_update_comissions == "create"
    ? comissions_store.createComissions(form_state)
    : comissions_store.updateComissions(form_state, comissions_store.items.comissions.selected_item.id);
};

const setForm = () => {
  //API WARNING
  //SELECTED ITEM COMES WITH API ATTRIBUTE NAMES
  form_state.description = 'Descripcion del Comissions '+comissions_store.items.comissions.selected_item.id;
...
onMounted(() => {
  if (comissions_store.forms.create_update_comissions != "create") setForm();
});
</script>

<script>
export default {
  name: "ComissionsFormComponent",
};
</script>
